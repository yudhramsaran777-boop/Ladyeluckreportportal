...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-30 flex flex-col gap-4 border-b border-panelborder bg-emerald-950/70 px-4 py-4 backdrop-blur md:flex-row md:items-center md:justify-between md:px-8">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute right-0 top-12 w-48 rounded-lg border border-panelborder bg-emerald-950 p-2 shadow-card">
